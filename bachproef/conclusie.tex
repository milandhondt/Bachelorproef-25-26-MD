...
Uit de gesprekken en feedback van lectoren bleek de JSON-output van onschatbare waarde. Wel kwamen er enkele belangrijke randvoorwaarden naar voren voordat zo'n systeem in de praktijk geïmplementeerd kan worden:
\begin{itemize}
