...
- Volledige repo in 1 keer wordt lastig omwege van token limieten. --> Scriptje schrijven die repo opdeelt. (oftewel file per file, oftewel opdelen in chuncks, oftewel eerst summarizen en dit dan naar model sturen).
