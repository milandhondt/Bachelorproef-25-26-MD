...
\begin{figure*}
    \centering
    \rotatebox{90}{%
        \includegraphics[height=\textwidth]{Gantt}%
    }
    \caption[Gantt Diagram]{\label{fig:gantt}Gantt-diagram met de verschillende fasen en milestones van het onderzoek.}
\end{figure*}
...
\begin{itemize}
    ...
    \item AI Agent Frameworks (zoals LangChain, CrewAI, Mastra AI) en hun rol bij betrouwbaarheid
...
\begin{itemize}
    ...
    \item het ontwikkelen van het orchestratiescript voor de automatische evaluatie
