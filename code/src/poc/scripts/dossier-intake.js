...
3. readFile op configuratiebestanden (bv. package.json, docker/config files, env voorbeelden)
...
RubricIndicatie (verplicht):
Vergelijk met het referentieproject en kies één van de volgende:
- "beter dan voorbeeldapp": uitgebreider, robuuster of creatiever geïmplementeerd.
- "analoog": vergelijkbaar met de voorbeeldapplicatie.
- "minder": deels geïmplementeerd maar blijf achter op het voorbeeld.
- "voldoet niet": ontbreekt of fundamenteel stuk.
