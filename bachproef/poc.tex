...
In dit hoofdstuk wordt de praktische implementatie van het onderzoek besproken in de vorm van een Proof-of-Concept (PoC). De opgebouwde testomgeving en het verloop van de geautomatiseerde evaluatie worden in detail toegelicht, waarna de technologische keuzes en een concreet voorbeeld van de input en output worden gepresenteerd. Tot slot worden de belangrijkste uitdagingen en beperkingen van deze implementatie besproken.
