...
De opkomst van Large Language Models (LLM’s) zoals ChatGPT, Gemini en GitHub Copilot heeft een duidelijke impact op de manier waarop software ontwikkeld wordt. Binnen het programmeeronderwijs worden deze modellen steeds vaker gebruikt door studenten om code te schrijven, te begrijpen en te verbeteren. Ook binnen projecten, waar studenten te maken krijgen met steeds grotere en complexere codebases, worden LLM's ingezet.

\vspace{1em}

Dat LLM's ingezet kunnen worden voor code generatie is duidelijk. Echter is hun rol bij het evalueren van code minder duidelijk. Meer specifiek, is het onduidelijk in welke mate LLM's kunnen bijdragen aan het evalueren van codekwaliteit en het genereren van formatieve feedback op studentenprojecten.

\vspace{1em}

De evaluatie van studentenprojecten binnen de vakken Front-End Web Development en Web Services kan een zeer complex en tijdsintensief proces zijn. Niet alleen is er technische kennis vereist, er is ook een nood aan het consistent toepassen van de evaluatiecriteria en daarboven moet er ook genoeg aandacht worden besteed aan het geven van inhoudelijke feedback. Hier zou het zeer interessant zijn om LLM's te gebruiken ter ondersteuning. Deze kunnen bepaalde repetitieve of structurele aspecten van de evaluatie ondersteunen. Echter is hun betrouwbaarheid, consistentie en bruikbaarheid nog onvoldoende onderzocht binnen deze context.

\vspace{1em}

Deze bachelorproef vertrekt vanuit de nood aan een beter inzicht in de mogelijkheden en beperkingen van LLM's, ter ondersteuning bij het evalueren van studentenprojecten binnen de vakken Front-End Web Development en Web Services. Dit onderwerp zal systematisch onderzocht worden en bijdragen aan het geven van een realistisch beeld van hoe LLM's al dan niet kunnen worden ingezet bij het evalueren van deze projecten.
