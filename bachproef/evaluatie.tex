...
\begin{enumerate}
    \item \textbf{Geen runtime-verificatie}: de AI kan niet controleren of de code daadwerkelijk uitvoerbaar is of bugvrij draait.
    \item \textbf{Sandbox-restricties}: restricties in de sandbox-omgeving kunnen er soms toe leiden dat de AI geen uitsluitsel kan geven over specifieke criteria.
\end{enumerate}
