...
\end{enumerate}
Als laatste zal er ook gekeken worden naar hoe de te grote projecten zullen worden opgesplitst, hier bestaan er namelijk ook verschillende manieren voor. Denk hierbij aan per bestand, per laag, via chunking, via een samenvatting,\dots
...
In de vijfde en laatste fase zal de conclusie worden opgebouwd. De resultaten van al het onderzoek worden gebundeld om objectief aan te tonen of LLMs mogelijks gebruikt kunnen worden voor het evalueren van studentenprojecten binnen het afgebakende probleemdomein. Verder worden de verschillende voor- en nadelen van de geëvalueerde modellen toegelicht, om de keuze voor lectoren te vergemakkelijken.
