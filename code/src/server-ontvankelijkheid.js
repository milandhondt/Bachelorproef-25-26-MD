...
async function startWizard() {
  console.log("==========================================");
  console.log("      Ontvankelijkheid Evaluator          ");
  console.log("==========================================\n");
  ...
  try {
    ...
    const { results, bundleOutputPath, failures } =
      await runOntvankelijkheidPipeline({
        projectDir: path.join(projectsDir, targetProject),
      });

    console.log("\n════════════════════════════════════════════");
    console.log("     Ontvankelijkheidsflow voltooid        ");
    console.log("══════════════════════════════════════════════");
    ...
    console.error("Ontvankelijkheidsflow mislukt.");
