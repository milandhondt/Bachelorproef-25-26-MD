...
Ter afsluiting van deze inleiding moet er kort aandacht zijn voor de AI act. De LLM gebaseerde feedbacktool die in dit onderzoek wordt gebruikt, valt onder de Europese Artificial Intelligence Act \autocite{EuropeseCommissie2023}. Omdat de output van de AI een directe invloed kan hebben op de beoordeling van de studentenprojecten, kan deze tool als high-risk geclassificeerd worden. Binnen de AI act worden voor deze high-risk systemen verschillende maatregelen opgesteld, die tijdens dit onderzoek ook in acht zullen genomen worden. Concreet wordt er binnen dit onderzoek rekening gehouden met menselijk toezicht, transparantie en risicobeperking. De door LLM-gegenereerde feedback zal uitsluitend gebruikt worden ter ondersteuning van de lectoren en heeft geen invloed op de uiteindelijke evaluatie van de studentenprojecten.

\section{Literatuurstudie}%
\label{sec:literatuurstudie}

De snelle opkomst van LLM's heeft het potentieel om verschillende aspecten van het programmeeronderwijs drastisch te veranderen. Waar vroeger vooral gebruik gemaakt werd van autograding, kunnen nu LLM's worden ingezet om meer kwalitatieve en contextbewuste feedback te genereren. Binnen deze literatuurstudie wordt gekeken naar autograding en hoe dit tot nu werd ingezet binnen het programmeeronderwijs. Verder wordt er gekeken naar recente onderzoeken waarbij AI gebruikt werd voor het evalueren van code en het ondersteunen van studenten. Daarnaast wordt er bekeken welke impact en risico's AI met zich meebrengt, en welke beperkingen LLM's hebben.
...
\leavevmode\par\noindent
In de eerste fase van dit onderzoek zal het probleemdomein verder worden ontdekt. Hiervoor zal er een interview worden afgenomen met de lectoren Front-end Web Development \& Web Services. Dit is namelijk de primaire doelgroep van deze bachelorproef. Deze interviews worden gedaan voor 3 redenen: 
\begin{itemize}
...
Het resultaat van deze fase is een duidelijker inzicht binnen het probleemdomein, een lijst met de verschillende evaluatiecriteria en een verzameling van studentenprojecten met uiteenlopende beoordelingen die gebruikt kunnen worden als testprojecten in een volgende fase.
...
\begin{itemize}
    \item Technische voordelen en beperkingen voor code-evaluatie (zoals bv. nauwkeurigheid en consistentie)
    \item Mogelijke nadelen, zoals hallucinaties, beperkte context, inconsistentie,\ldots
...
\leavevmode\par\noindent 
De vierde fase zal het individueel evalueren van verschillende LLMs omvatten, meer bepaald op hun toepassing bij het evalueren van studentenprojecten. Op basis van de literatuurstudie zullen de meest relevante en bruikbare modellen worden gekozen, en deze zullen individueel worden beoordeeld op hun vermogen om code te analyseren, en formatieve feedback te genereren. Naast de inhoudelijke kwaliteit van de gegenereerde feedback, zal er ook gekeken worden naar performance-gerelateerde aspecten. Hierbij worden volgende criteria onderzocht:
\begin{itemize}
